...
public class SiparisAyrintiEventHandler {
     ...
     * @see ListenerList
     */
    public void fireSiparisAyrintiChanged(List<Siparis_ayrinti> list) {
        ...
        for (int i = listeners.length-2; i>=0; i-=2) {
            if (listeners[i]==DataListener.class) {
            	DataChangedEvent<Siparis_ayrinti> event = new DataChangedEvent<Siparis_ayrinti>(this,
    					list);
    ...
    public void fireSiparisAyrintiChanged() {
        // Guaranteed to return a non-null array
        Object[] listeners = listenerList.getListenerList();
        // Process the listeners last to first, notifying
        // those that are interested in this event
