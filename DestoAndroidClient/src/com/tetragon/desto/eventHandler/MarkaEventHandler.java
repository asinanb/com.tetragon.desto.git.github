...
public class MarkaEventHandler {
     ...
     * @see ListenerList
     */
    public void fireMarkaChanged(List<Marka> dataList) {
        ...
        for (int i = listeners.length-2; i>=0; i-=2) {
            if (listeners[i]==DataListener.class) {
            	DataChangedEvent<Marka> event = new DataChangedEvent<Marka>(this,
    					dataList);
