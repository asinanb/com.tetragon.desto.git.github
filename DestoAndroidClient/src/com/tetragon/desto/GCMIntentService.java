	...
	private static String doRegister(Context context) {
		...
		try {
			GoogleCloudMessaging gcm = GoogleCloudMessaging
					.getInstance(context);
			// --SB 24.10.2014
			// Asagiya .substring(0,16); eklendi
			// _DeviceSubscription Entities icine 500 den uzun kayýt atýnca
			// calismadigindan
...
//			msg = "Device registered, registration ID=" + regId;
			...
			//SB Bura varya acaip problem.. genymotion üzerinden çalýþtýðýnda cihazý
			//kaydedemeyip her seferinde bir hata yazýyor sonunda da error 400 patlýyor
			// alt satýrý kapattým bu yüzden 09/04/2015
